...
## Installation
``` bash
npm install "https://github.com/BitilWallet/bitcoiniljs-lib.git#v6.0.0"
...
- [Taproot Key Spend](https://github.com/BitilWallet/bitcoiniljs-lib/blob/master/test/integration/taproot.md)
